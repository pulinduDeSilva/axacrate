...
function pointerPrototype() {
    ...
    this.down = false;
    this.moved = false;
    this.color = [0.3, 0.18, 0.08];  // Matching light orange
}
...
function getResolution(resolution) {
    ...
    if (gl.drawingBufferWidth > gl.drawingBufferHeight) return {width: max, height: min}; else return {
